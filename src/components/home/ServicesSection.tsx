import { FileText, ClipboardCheck, FileSearch, AlertOctagon, Thermometer, Gavel, HardHat, Cog } from "lucide-react";
...
const services = [
  { icon: FileText, title: "Elaboração de PGR", desc: "Programa de Gerenciamento de Riscos conforme a NR-01, com inventário e plano de ação." },
