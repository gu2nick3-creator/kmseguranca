...
import { FileText, ClipboardCheck, FileSearch, AlertOctagon, Thermometer, Gavel, HardHat, Cog, MessageCircle, BadgeCheck, Stethoscope, SendToBack, ShieldAlert } from "lucide-react";
import safetyImg from "@/assets/hero-safety.jpg";
import { buildWhatsAppUrl } from "@/lib/whatsapp";
import { trackEvent } from "@/lib/analytics";

const WHATSAPP_URL = buildWhatsAppUrl("Olá! Gostaria de saber mais sobre os serviços.");
...
const services = [
  ...
  { icon: Stethoscope, title: "Gestão do PCMSO / Medicina do Trabalho", desc: "Gestão completa do PCMSO com emissão de ASO, exames admissionais, demissionais, periódicos e monitoramento da saúde ocupacional." },
  { icon: ShieldAlert, title: "Gestão de Riscos Psicossociais (NR-01)", desc: "Implementação e atualização do PGR com identificação obrigatória, gerenciamento dos fatores de riscos psicossociais e estratégias de prevenção ao assédio e à violência no trabalho." },
  { icon: SendToBack, title: "Envio de eventos do eSocial", desc: "Envio técnico dos eventos S-2210 (CAT), S-2220 (Saúde Ocupacional), S-2240 (Condições Ambientais e Agentes Nocivos) e S-2221 (Exames Toxicológicos)." },
  ...
  { icon: Cog, title: "Implantação de Processos de Segurança do Trabalho", desc: "Desenvolvimento e implantação de cultura de segurança, procedimentos operacionais, SIPAT e integração de novos colaboradores." },
];
            ...
            <div className="grid lg:grid-cols-2 gap-10 items-center">
              ...
              <div ref={contentRef}>
                ...
                <a
                  ...
                  onClick={() => trackEvent("whatsapp_click", { local: "services_page" })}
